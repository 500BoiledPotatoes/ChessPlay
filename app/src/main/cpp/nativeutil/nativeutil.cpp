 ...
 */
extern "C" JNIEXPORT jboolean JNICALL Java_com_example_chessplay_engine_EngineUtil_chmod
 ...
 * Signature: (II)V
 */
extern "C" JNIEXPORT void JNICALL Java_com_example_chessplay_engine_EngineUtil_reNice
 ...
 * Signature: ()Z
 */
extern "C" JNIEXPORT jboolean JNICALL Java_com_example_chessplay_engine_EngineUtil_isSimdSupported
    (JNIEnv *env, jclass) {
#if defined(__arm__)
